...
class Database extends PDO
{
    ...
    public function where($column, $value, $operator = '=')
    {
        ...
        } elseif (strtolower($operator) == 'is' || strtolower($operator) == 'is not') {
            $operator = ' '.strtoupper($operator).' ';
     ...
     * @return \Database
     */
    public function join($column1, $column2)
    {
     ...
     * @return \Database
     */
    public function right_join($table, $column1, $column2)
    {
        $column1 = str_replace('.', '`.`', $column1);
        $column2 = str_replace('.', '`.`', $column2);
     ...
     * @return \Database
     */
    public function left_join($table, $column1, $column2)
    {
        $column1 = str_replace('.', '`.`', $column1);
        $column2 = str_replace('.', '`.`', $column2);
    ...
    public function inner_join($table, $column1, $column2)
    {
        $column1 = str_replace('.', '`.`', $column1);
        $column2 = str_replace('.', '`.`', $column2);
    ...
    public function run()
    {
        ...
        if ($this->_qbType == 'select') {
            ...
            } elseif ($this->_qbType == 'update' || $this->_qbType == 'delete') {
     ...
     */
    public function select_raw($sql, $array = [], $fetchMode = PDO::FETCH_ASSOC)
    {
     ...
     * @deprecated
     */
    public function select_extend($fields, $table, $array = [], $group = [], $order = [], $limit = 0, $fetchMode = PDO::FETCH_ASSOC)
    {
     ...
     * @deprecated
     */
    public function update_extend($table, $data, $where = [])
    {
        $fieldDetails = null;
